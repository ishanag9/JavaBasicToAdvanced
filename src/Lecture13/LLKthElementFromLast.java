...
public class LLKthElementFromLast {
    private class Node {
        int data;
        Node next;
    ...
    public static void main(String[] args) throws Exception {
        LLKthElementFromLast list = new LLKthElementFromLast();
        ...
        int n = s.nextInt();
        System.out.println(list.KthNodeFromEnd(n));
    }
